...
namespace Dictionaries_Fulton_Christopher
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            topGames.Add(2, "Borderlands 3");
            topGames.Add(3, "Helldivers 2");
            topGames.Add(4, "Limbus Company");
            topGames.Add(5, "Sims 4");
            topGames.Add(6, "Animal Crossing");
            topGames.Add(7, "Halo 5");
            topGames.Add(8, "Cult Of The Lamb");
            topGames.Add(9, "SuperLiminal");
            topGames.Add(10, "Space marines 2");
